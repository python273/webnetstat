...
proc x_start_pcap_loop(filter_exp: cstring, callback: pcap_handler): cint {.importc.}
...
proc startPcapLoop*(filter_exp: string) =
  discard x_start_pcap_loop(filter_exp, handlePacket)
